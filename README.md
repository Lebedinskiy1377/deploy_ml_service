...
Оптимизация: 30 цен-кандидатов в диапазоне 70%..130% от цены из запроса плюс сама эта цена, все кандидаты считаются одним вызовом модели. Кривая спроса дополнительно делается невозрастающей изотонической регрессией. Для каждого кандидата:
